...
public enum BeanTypeEnum {
    ...
    PEOPLE("people", "实有人口",
            new String[]{"楼宇功能", "类型", "户主/出租人", "身份证号码", "联系方式", "人数",
                    "租住人", "寄住人", "从业人员", "备注", "警务区"},
            new int[]{/*楼宇功能*/50,/*类型*/ 50,/*户主/出租人*/ 50,/*身份证号码*/ 50, /*联系方式*/50,/*人数*/ 5,
                    /*租住人*/50, /*寄住人*/50,/*从业人员*/ 200,/*备注*/ 200,/*警务区*/ 50}),

    HOUSE("house", "实有房屋",
            new String[]{"楼宇功能", "类别", "产权人", "户主/房主", "身份证号码", "联系方式", "从业人员",
                    "地址", "单元", "楼层", "门牌号", "备注", "警务区"},
            new int[]{/*楼宇功能*/50,/*类别*/ 50,/*产权人*/ 50, /*户主/房主*/50,/*身份证号码*/ 50,/*联系方式*/ 50, /*从业人员*/50,
                    /*地址*/200, /*单元*/50, /*楼层*/3,/*门牌号*/ 200, /*备注*/200,/*警务区*/ 50}),

    EMPLOYER("employer", "实有单位", new String[]{"单位级别", "名称", "负责人", "身份证号码", "联系方式",
            "内保负责人", "身份证号码", "联系方式", "地址", "备注", "警务区"},
            new int[]{/*单位级别*/50, /*名称*/50, /*负责人*/50, /*身份证号码*/50, /*联系方式*/50,
                    /*内保负责人*/50, /*身份证号码*/50, /*联系方式*/50, /*地址*/200, /*备注*/200, /*警务区*/50}),

    PLACE("place", "实有场所",
            new String[]{"类型", "名称", "地址", "面积", "出租人", "身份证号码", "联系方式",
                    "租住人", "身份证号码", "联系方式", "备注", "警务区"},
            new int[]{/*类型*/50, /*名称*/50, /*地址*/200, /*面积*/50, /*出租人*/50,/*身份证号码*/ 50, /*联系方式*/50,
                    /*租住人*/50, /*身份证号码*/50, /*联系方式*/50, /*备注*/200, /*警务区*/50}),
